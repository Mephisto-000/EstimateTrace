...
EstimateTrace 是公開、免費的軟體需求估算工具，協助你把需求、工時、風險、成本
和乙方報價整理在一起，讓估算更容易檢查、重算和說明。

> 本工具只供參考，不是正式報價、採購或法律意見。公開示範參數不是市場標準，
> 也不代表任何公司或產業的合理價格。
...
![EstimateTrace 網站首頁](imgs/mainPage.png)

## 功能

- 用五個步驟拆需求、估工時、設定風險和成本，再看結果。
- 計算 P50、P80 工時、工程成本和參考報價。
- 先統一未稅基準，再比較含稅／未稅乙方報價。
- 可以展開查看公式、代入值、單位、來源和參數版本。
...
- [v0.1.8 發行說明](docs/releases/v0.1.8.md)
- [v0.1.7 發行說明](docs/releases/v0.1.7.md)
- [v0.1.6 發行說明](docs/releases/v0.1.6.md)
